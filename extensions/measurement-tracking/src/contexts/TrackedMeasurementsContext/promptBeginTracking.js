...
//   // Trigger measurement display (if applicable)
//   if (measurementService && SeriesInstanceUID) {
//     try {
//       measurementService.trackMeasurements({
//         StudyInstanceUID,
//         SeriesInstanceUID,
//         viewportId,
//       });
//     } catch (error) {
//       console.error('Error displaying measurements:', error);
//     }
//   }

//   // Resolve with the default response
//   resolve({
...
function promptBeginTracking({ servicesManager }, ctx, evt) {
  const { measurementService } = servicesManager.services;
  ...
  return new Promise(function (resolve) {
    // Automatically trigger measurement tracking (if applicable)
    if (measurementService && SeriesInstanceUID) {
      try {
        measurementService.trackMeasurements({
          StudyInstanceUID,
    ...
    // Resolve with default response (SET_STUDY_AND_SERIES)
    resolve({
      userResponse: RESPONSE.SET_STUDY_AND_SERIES,
      StudyInstanceUID,
      SeriesInstanceUID,
